...
if ($_POST) {
    ...
    if (empty($nama)) {
        ...
        include "koneksi.php";
        $insert = mysqli_query($conn, "INSERT INTO tabel_pegawai (nama , nik , no_tlpn , alamat , jenis_kelamin , password , id_jabatan) value ('" . $nama . "','" . $nik . "','" . $no_tlpn . "','" . $alamat . "','" . $jenis_kelamin . "','" . md5($password) . "','" . $id_jabatan . "')") or die(mysqli_error($conn));
        if ($insert) {
